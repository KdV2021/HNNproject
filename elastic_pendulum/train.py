...
def get_args():
    ...
    parser.add_argument('--baseline', default=False, dest='baseline', action='store_true',
...
def train(args):
    ...
    stats['train_loss'].append(100.)
    stats['test_loss'].append(100.)
    for step in range(args.total_steps + 1):
        ...
        if args.verbose and step % args.print_every == 0:
            ...
            if step > 199 and test_loss.item() > stats['test_loss'][-200] and test_loss.item() < 5.0:
                break
